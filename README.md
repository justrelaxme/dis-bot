...
| `/progression` | администратору | роли за уровень, товары, новый сезон, ручное начисление |
...
Сезон обнуляет зачёт, но не историю: журнал начислений и достижения остаются.
